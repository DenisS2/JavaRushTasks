...
public class LevelLoader {
    ...
    /*public GameObjects getLevel(int level){
        ...
        walls.add(new Wall((100 / (Model.FIELD_CELL_SIZE / 2)),(100 / (Model.FIELD_CELL_SIZE / 2))));
        walls.add(new Wall((100 / (Model.FIELD_CELL_SIZE / 2)),(100 / (Model.FIELD_CELL_SIZE / 2))));
        walls.add(new Wall((100 / (Model.FIELD_CELL_SIZE / 2)),(100 / (Model.FIELD_CELL_SIZE / 2))));
        walls.add(new Wall((100 / (Model.FIELD_CELL_SIZE / 2)),(100 / (Model.FIELD_CELL_SIZE / 2))));
        Set<Box> boxes=new HashSet<Box>();
        boxes.add(new Box((100 / (Model.FIELD_CELL_SIZE / 2)),(100 / (Model.FIELD_CELL_SIZE / 2))));
        Set<Home> homes=new HashSet<Home>();
        homes.add(new Home((100 / (Model.FIELD_CELL_SIZE / 2)),(100 / (Model.FIELD_CELL_SIZE / 2))));
        Player player= new Player((100 / (Model.FIELD_CELL_SIZE / 2)),(100 / (Model.FIELD_CELL_SIZE / 2)));
